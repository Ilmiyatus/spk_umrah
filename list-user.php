...
<?php 
include_once('template-parts/sidebar-user.php'); 
?>
		...
		<tbody>
			<?php while($hasil = $query->fetch()): ?>
				<tr>
					...
					<td><a href="hapus-user.php?id=<?php echo $hasil['id_user']; ?>" class="red yakin-hapus"><span class="fa fa-times"></span> Hapus</a></td>
				</tr>
			<?php endwhile; ?>
		</tbody>
	</table>
