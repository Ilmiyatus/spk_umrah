...
?>
	...
	<div class="container clearfix">
		...
		<div class="main-content the-content">
			...
			<p><a href="edit-user.php?id=<?php echo $id_user; ?>" class="button"><span class="fa fa-pencil"></span> Edit</a> &nbsp; <a href="hapus-user.php?id=<?php echo $id_user; ?>" class="button button-red yakin-hapus"><span class="fa fa-times"></span> Hapus</a></p>
