...
if(isset($_POST['submit'])):	
	...
	if(empty($errors)):
		...
		$handle = $pdo->prepare('INSERT INTO kriteria (nama, type, bobot, urutan_order) VALUES (:nama, :type, :bobot, :urutan_order)');
		...
		if($id_kriteria == 1 && !empty($pilihan)): foreach($pilihan as $pil):
			...
			<?php endif; ?>			
				...
				<form action="tambah-kriteria.php" method="post">
					...
					<div class="field-wrap clearfix">					
						...
						<input type="number" name="bobot" value="<?php echo $bobot; ?>" step="0.0001">
					</div>
					<div class="field-wrap clearfix">					
